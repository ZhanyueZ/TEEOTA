...
#define  TICK_INT_PRIORITY          (5UL)  /*!< tick interrupt priority (lowest by default); must be >= configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY and <= configLIBRARY_LOWEST_INTERRUPT_PRIORITY   */
#define  USE_RTOS                   0U
