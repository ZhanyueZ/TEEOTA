...
C_DEPS += \
./Application/User/Common/net/mbedtls_transport.d 


# Each subdirectory must supply rules for building sources it contributes
Application/User/Common/net/mbedtls_transport.o: C:/Users/89336/STM32CubeIDE/workspace_1.13.1/en.x-cube-aws-h5-v1-0-0/STM32CubeExpansion_Cloud_AWS_H5_V1.0.0/Projects/Common/net/mbedtls_transport.c Application/User/Common/net/subdir.mk
...
clean: clean-Application-2f-User-2f-Common-2f-net

clean-Application-2f-User-2f-Common-2f-net:
	-$(RM) ./Application/User/Common/net/mbedtls_transport.cyclo ./Application/User/Common/net/mbedtls_transport.d ./Application/User/Common/net/mbedtls_transport.o ./Application/User/Common/net/mbedtls_transport.su

.PHONY: clean-Application-2f-User-2f-Common-2f-net
